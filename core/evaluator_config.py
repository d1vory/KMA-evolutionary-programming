...
N_DEFAULT_VALUES = [100, 200, 300, 400]
#MAX_ITERATION_DEFAULT = 10_000_000

#MAX_ITERATION_DEFAULT = 1_000_000
#MAX_ITERATION_DEFAULT = 100_000
MAX_ITERATION_DEFAULT = 15_000
EPOCHS_DEFAULT = 100
#EPOCHS_DEFAULT = 10
...
####################################################################################################################################
    ...
    #     optimal=utils.encode_binary(x=10.23, a=0, b=10.23, m=10),
    ...
    #     length=10,
    #     handler=fitness_functions.FX,
    #     optimal=utils.encode_binary(0, -5.11, 5.12, 10),
    ...
    #     "f=x", generators.RealGenerator, "full", 10, fitness_functions.FX, utils.encode_binary(10.23, 0, 10.23, 10),
    #     {"mode": "x", "a": 0, "b": 10.23, "m": 10, "low": 0, "high": 10.23}
    # ),
    # "f=x^4": FitnessFunctionConfig(
    #     "f=x^4", generators.RealGenerator, "full", 10, fitness_functions.FX, utils.encode_binary(10.23, 0, 10.23, 10),
    #     {"mode": "x^4", "a": 0, "b": 10.23, "m": 10, "low": 0, "high": 10952.22947841},
    # ),
    # "f=2x^2": FitnessFunctionConfig(
    #     "f=2x^2", generators.NormalGenerator, "full", 10, fitness_functions.FX, utils.encode_binary(10.23, 0, 10.23, 10),
    ...
    #     utils.encode_binary(0, -5.11, 5.12, 10),
    ...
    #     utils.encode_binary(10.23, 0, 10.23, 10),
    #     {"c": 0.25, "a": 0, "b": 10.23, "m": 10}
    # ),
    # "f=e^(1*x)": FitnessFunctionConfig(
    #     "f=e^(1*x)", generators.NormalGenerator, "full", 10, fitness_functions.FECX, utils.encode_binary(10.23, 0, 10.23, 10),
    #     {"c": 1.0, "a": 0, "b": 10.23, "m": 10}
    # ),
    # "f=e^(2*x)": FitnessFunctionConfig(
    #     "f=e^(2*x)", generators.NormalGenerator, "full", 10, fitness_functions.FECX, utils.encode_binary(10.23, 0, 10.23, 10),
